      ...
      {(generations?.length ?? 0) > 0 && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="rounded-xl border border-border/60 bg-card/60 p-3.5">
            ...
            <div className="mt-1 text-2xl font-serif font-bold">
              {stats.total}
            </div>
          </div>
          <div className="rounded-xl border border-border/60 bg-card/60 p-3.5">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 px-6 border-2 border-dashed border-border/60 rounded-2xl bg-gradient-to-b from-card/60 to-muted/20">
          ...
          <p className="text-muted-foreground text-sm mb-6 max-w-sm mx-auto">
            Generate your first deck to start building history.
          </p>
          <Link href="/decks">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge
                          variant="outline"
                          className="gap-1 text-[10px] font-normal capitalize"
                        >
                      ...
                      <div className="mt-1.5 flex items-center gap-3 text-[11px] text-muted-foreground flex-wrap">
                        <span
                          ...
                          title={format(startedDate, "PPpp")}
                        >
                          {formatDistanceToNow(startedDate, {
                            addSuffix: true,
                          })}
                        </span>
      ...
      <Dialog open={confirmClear} onOpenChange={setConfirmClear}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This deletes the log of past generation runs. Your decks and cards
              are not affected.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
